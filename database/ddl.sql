...
EXEC sys.sp_addextendedproperty @name=N'MS_Description', @value=N'1노출 2 숨김' , @level0type=N'SCHEMA',@level0name=N'dbo', @level1type=N'TABLE',@level1name=N'TB_OWNER', @level2type=N'COLUMN',@level2name=N'STORE_STATUS';
